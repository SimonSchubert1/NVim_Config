    ...
    config = function()
        ...
        local config = {
            options = {
                ...
                disabled_filetypes = {
                    ...
                    winbar = { "alpha", "dashboard", "neo-tree", "Outline" },
                },
            },
            sections = {
        ...
        ins_left({
            ...
            function()
                ...
                local nonNullLsClients = {}
                for _, client in ipairs(clients) do
                    if client.name ~= "null-ls" then
                        table.insert(nonNullLsClients, client)
                    end
                end
                if #nonNullLsClients == 1 then
                    return nonNullLsClients[1].name
                end
                for _, client in ipairs(clients) do
