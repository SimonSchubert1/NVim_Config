...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  colorschemes = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/colorschemes",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/kali/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
